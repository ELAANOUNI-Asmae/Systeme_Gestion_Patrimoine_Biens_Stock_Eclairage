  ...
  const handleCreateRequest = async (data: {
    ...
    try {
      ...
      await notificationService.createManual({
        ...
        targetUrl: "/stock",
        recipientPermission:
          PERMISSIONS.APROUVE_ITEM_REQUEST,
      });
    ...
    <section className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 xl:flex-row xl:items-center">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <PermissionGuard
            permission={PERMISSIONS.CREATE_ITEM_REQUEST}
          >
            <button
              type="button"
          ...
          <PermissionGuard
            permission={PERMISSIONS.CREATE_ITEM}
          >
            <Link
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <PermissionGuard
          permission={PERMISSIONS.GET_STOCK_MOVEMENT_PER_ITEM}
        >
            ...
            {requests.length === 0 ? (
              ...
              requests.map((request) => (
                <RequestCard
                  ...
                  canReject={
                    user?.role.permissions.includes(
                      PERMISSIONS.REJECT_ITEM_REQUEST,
                    ) ?? false
                  }
                  onApprove={() => {
