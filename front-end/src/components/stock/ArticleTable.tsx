                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <div className="flex justify-end gap-1 rtl:justify-start">
                        <PermissionGuard permission={PERMISSIONS.CREATE_IN_STOCK}>
                          <button
                            type="button"
                        ...
                        <PermissionGuard permission={PERMISSIONS.UPDATE_ITEM_QUANTITY}>
                          <button
                            type="button"
                        ...
                        <PermissionGuard permission={PERMISSIONS.DELETE_ITEM}>
                          <button
                            type="button"
