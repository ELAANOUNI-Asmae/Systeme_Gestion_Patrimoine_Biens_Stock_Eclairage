                    ...
                    <td className="whitespace-nowrap px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-orange-100 font-bold text-orange-700 dark:bg-orange-500/15 dark:text-orange-300">
                          {displayFirstName.charAt(
                            0,
                          )}
                          {displayLastName.charAt(
                            0,
                          )}
                        </div>
                          ...
                          <button
                            ...
                            className={`rounded-lg p-2 transition ${
                              user.active
                                ...
                                : "text-slate-500 hover:bg-green-50 hover:text-green-600 dark:text-slate-400 dark:hover:bg-green-500/10 dark:hover:text-green-400"
                            }`}
                          >
                            {user.active ? (
                              <UserX
