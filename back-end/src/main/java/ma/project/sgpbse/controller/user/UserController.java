...
public class UserController {
    ...
    //show current connected user profile
    @GetMapping("/me")
    public ResponseEntity<UserProfilDtoResponse> getCurrentUserProfile(){
        return ResponseEntity.ok(
                userMapper.toDtoProfil(
    ...
    @PutMapping("/me")
    public ResponseEntity<UserProfilDtoResponse> updateCurrentUserProfile(
