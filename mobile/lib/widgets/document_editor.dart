...
class DocumentEditor extends StatelessWidget {
  ...
  // Used for documents already stored in the Backend.
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              message ??
                  context.tr(
                    'Aucun aperçu n’est disponible pour ce fichier. Les documents stockés dans le backend sont téléchargés à la demande lorsqu’un identifiant est disponible.',
                    'لا تتوفر معاينة لهذا الملف. يتم تحميل الوثائق المخزنة في الخادم عند الطلب عندما يكون المعرّف متوفراً.',
                  ),
              textAlign: TextAlign.center,
            ),
          ],
